...
function Aboutclub() {
    return (
        <div className='container row'style={aboutStyle}>
            <img src="assets/photos/heart.png" className='col-12 col-lg-6'style={heartStyle} alt="heart" />
            <div className='col-12 col-lg-6'style={{fontSize:'24px'}}>
                <b style={{ fontSize: '30px' }}>Prakruti</b> is the social welfare club formed from the merger of two other clubs, Animals Welfare club and Incredible NITT. We believe that true beauty is found in nature, and we work to preserve the natural flora and fauna of the campus.
...
const aboutStyle = {
    ...
    borderRadius: '13px',
background: 'pink',
boxShadow:  '21px 21px 38px #bcbcbc,-21px -21px 38px #ffffff',
    padding: '40px',
    color: 'black',
}
